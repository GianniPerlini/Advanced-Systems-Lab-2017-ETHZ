...
function gnuplot_th_1 {
        (cat <<EndofMessage
set terminal png
set output 'bl1_set_th_first.png'
set xlabel "Number of Clients"
set ylabel "Throughput [SET] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl1_set_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 1"
...
function gnuplot_th_2 {
        (cat <<EndofMessage
set terminal png
set output 'bl2_set_th_sec.png'
set xlabel "Number of Clients"
set ylabel "Throughput [SET] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl2_set_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 2"
...
function gnuplot_th_3 {
        (cat <<EndofMessage
set terminal png
set output 'bl3_set_th_third.png'
set xlabel "Number of Clients"
set ylabel "Throughput [SET] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl3_set_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 3"
...
set style line 1 lc rgb '#ff0000' lt 1 lw 2 pt 5 ps 1.5
set style line 2 lc rgb '#00ff00' lt 1 lw 2 pt 7 ps 1.5
set style line 3 lc rgb '#0000ff' lt 1 lw 2 pt 8 ps 1.5
...
function gnuplot_rt_1 {
        (cat <<EndofMessage
set terminal png
set output 'bl1_set_rt_first.png'
set style line 1 lc rgb '#ff0000' lt 1 lw 2 pt 5 ps 1.5
set style line 2 lc rgb '#00ff00' lt "dashed" lw 2 pt 7 ps 1
set xlabel "Number of Clients"
set ylabel "Response Time [SET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl1_set_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 1" ls 1
...
function gnuplot_rt_2 {
        (cat <<EndofMessage
set terminal png
set output 'bl2_set_rt_sec.png'
set xlabel "Number of Clients"
set ylabel "Response Time [SET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl2_set_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 2"
...
function gnuplot_rt_3 {
        (cat <<EndofMessage
set terminal png
set output 'bl3_set_rt_third.png'
set xlabel "Number of Clients"
set ylabel "Response Time [SET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl3_set_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 3"
...
function th_tot_3_rep {
        (cat <<EndofMessage
set terminal png
set key top left
set style line 1 lc rgb '#0060ad' lt 1 lw 2 pt 5 ps 1.5
set style line 2 lc "black" lt "dashed" lw 1 pt 7 ps 1
set output 'bl_set_th_tot_3_rep.png'
set xlabel "Number of Clients"
set ylabel "Throughput [SET] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36]
