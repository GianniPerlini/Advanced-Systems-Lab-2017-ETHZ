...
function gnuplot_th_1 {
        (cat <<EndofMessage
set terminal png
set output 'bl1_get_th_first.png'
set xlabel "Number of Clients"
set ylabel "Throughput [GET ops] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl1_get_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 1"
EndofMessage
)>$gnu_script
    $gnuplot $gnu_script
}
...
function gnuplot_th_2 {
        (cat <<EndofMessage
set terminal png
set output 'bl2_get_th_second.png'
set xlabel "Number of Clients"
set ylabel "Throughput [GET ops] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl2_get_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 2"
EndofMessage
)>$gnu_script
    $gnuplot $gnu_script
}
...
function gnuplot_th_3 {
        (cat <<EndofMessage
set terminal png
set output 'bl3_get_th_third.png'
set xlabel "Number of Clients"
set ylabel "Throughput [GET ops] [ops/s]"
set title  "Throughput per Number of Clients"
set xrange [0:36] 
set yrange [0:3000]
plot "bl3_get_data.txt" using 1:2:3:xticlabel(1) with errorlines title "Repetition 3"
EndofMessage
)>$gnu_script
    $gnuplot $gnu_script
}
...
function gnuplot_rt_1 {
        (cat <<EndofMessage
set terminal png
set output 'bl1_get_rt_first.png'
set xlabel "Number of Clients"
set ylabel "Response Time [GET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl1_get_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 1"
...
function gnuplot_rt_2 {
        (cat <<EndofMessage
set terminal png
set output 'bl2_get_rt_sec.png'
set xlabel "Number of Clients"
set ylabel "Response Time [GET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl2_get_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 2"
...
function gnuplot_rt_3 {
        (cat <<EndofMessage
set terminal png
set output 'bl3_get_rt_third.png'
set xlabel "Number of Clients"
set ylabel "Response Time [GET] [ms]"
set title  "Response Time per Number of Clients"
set xrange [0:36]
set yrange [0:20]
plot "bl3_get_data.txt" using 1:4:5:xticlabel(1) with errorlines title "Repetition 3"
