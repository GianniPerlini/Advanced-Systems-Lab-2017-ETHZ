...
set xrange [0:10] 
set yrange [0:3.5]
plot "TSRBMG_data.txt" using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "Multi Get" ls 1, "TSBS_data.txt" using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "Set" ls 2
