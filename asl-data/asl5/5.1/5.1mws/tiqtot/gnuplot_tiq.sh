...
set xrange [0:10] 
set yrange [0:2.5]
plot "TIQG_data.txt" using 1:(\$2/100000):(\$3/100000):xticlabel(1) with errorlines title "Multi Get" ls 1, \
"TIQS_data.txt" using 1:(\$2/100000):(\$3/100000):xticlabel(1) with errorlines title "Set" ls 2
