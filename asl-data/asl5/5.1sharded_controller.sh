...
for rep in "${reps[@]}"; do
	for k in "${keysize[@]}"; do
		...
		if [ "${k}" = "6" ] 
		then
			ssh perlinig-ethz@perlinig-ethzforaslvms4.westeurope.cloudapp.azure.com java -jar asl17-project-mw-ex5.jar -l 10.0.0.7 -p 8998 -t 64 -s true -m 10.0.0.4:9000 10.0.0.10:9001 10.0.0.11:9002 -k true & 
			ssh perlinig-ethz@perlinig-ethzforaslvms5.westeurope.cloudapp.azure.com java -jar asl17-project-mw-ex5.jar -l 10.0.0.8 -p 8999 -t 64 -s true -m 10.0.0.4:9000 10.0.0.10:9001 10.0.0.11:9002 -k true &
			sleep 4
		else
			ssh perlinig-ethz@perlinig-ethzforaslvms4.westeurope.cloudapp.azure.com java -jar asl17-project-mw-ex5.jar -l 10.0.0.7 -p 8998 -t 64 -s true -m 10.0.0.4:9000 10.0.0.10:9001 10.0.0.11:9002 -k false & 
			ssh perlinig-ethz@perlinig-ethzforaslvms5.westeurope.cloudapp.azure.com java -jar asl17-project-mw-ex5.jar -l 10.0.0.8 -p 8999 -t 64 -s true -m 10.0.0.4:9000 10.0.0.10:9001 10.0.0.11:9002 -k false &
			sleep 4
		fi

		# start two memtier instances in parallel in each VM
		ssh perlinig-ethz@perlinig-ethzforaslvms1.westeurope.cloudapp.azure.com memtier_benchmark --port=8998 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.7 --clients=2 -t 1 --client-stats=vm1mem1_r${rep}k${k} >> exp5.1_vm1_mem1r${rep}k${k}.txt 2>&1 &

		ssh perlinig-ethz@perlinig-ethzforaslvms1.westeurope.cloudapp.azure.com memtier_benchmark --port=8999 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.8 --clients=2 -t 1 --client-stats=vm1mem2_r${rep}k${k} >> exp5.1_vm1_mem2r${rep}k${k}.txt 2>&1 &
		
		ssh perlinig-ethz@perlinig-ethzforaslvms2.westeurope.cloudapp.azure.com memtier_benchmark --port=8998 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.7 --clients=2 -t 1 --client-stats=vm2mem1_r${rep}k${k} >> exp5.1_vm2_mem1r${rep}k${k}.txt 2>&1 &

		ssh perlinig-ethz@perlinig-ethzforaslvms2.westeurope.cloudapp.azure.com memtier_benchmark --port=8999 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.8 --clients=2 -t 1 --client-stats=vm2mem2_r${rep}k${k} >> exp5.1_vm2_mem2r${rep}k${k}.txt 2>&1 &
		
		ssh perlinig-ethz@perlinig-ethzforaslvms3.westeurope.cloudapp.azure.com memtier_benchmark --port=8998 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.7 --clients=2 -t 1 --client-stats=vm3mem1_r${rep}k${k} >> exp5.1_vm3_mem1r${rep}k${k}.txt 2>&1 &

		ssh perlinig-ethz@perlinig-ethzforaslvms3.westeurope.cloudapp.azure.com memtier_benchmark --port=8999 --protocol=memcache_text --ratio=1:${k} --multi-key-get=${k} --expiry-range=9999-10000 --key-maximum=10000 -d 1024 --hide-histogram --test-time=80 --server=10.0.0.8 --clients=2 -t 1 --client-stats=vm3mem2_r${rep}k${k} >> exp5.1_vm3_mem2r${rep}k${k}.txt 2>&1
		
		mv /home/gianni/Scrivania/exp5.1_vm1_mem1r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm1/mem1
		mv /home/gianni/Scrivania/exp5.1_vm1_mem2r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm1/mem2
		scp perlinig-ethz@perlinig-ethzforaslvms1.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm1mem1_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm1/mem1
		scp perlinig-ethz@perlinig-ethzforaslvms1.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm1mem2_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm1/mem2

		mv /home/gianni/Scrivania/exp5.1_vm2_mem1r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm2/mem1
		mv /home/gianni/Scrivania/exp5.1_vm2_mem2r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm2/mem2
		scp perlinig-ethz@perlinig-ethzforaslvms2.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm2mem1_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm2/mem1
		scp perlinig-ethz@perlinig-ethzforaslvms2.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm2mem2_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm2/mem2

		mv /home/gianni/Scrivania/exp5.1_vm3_mem1r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm3/mem1
		mv /home/gianni/Scrivania/exp5.1_vm3_mem2r${rep}k${k}.txt /home/gianni/Scrivania/ASL5.1vm3/mem2
		scp perlinig-ethz@perlinig-ethzforaslvms3.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm3mem1_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm3/mem1
		scp perlinig-ethz@perlinig-ethzforaslvms3.westeurope.cloudapp.azure.com:/home/perlinig-ethz/vm3mem2_r${rep}k${k}-*.csv /home/gianni/Scrivania/ASL5.1vm3/mem2
		...
		scp perlinig-ethz@perlinig-ethzforaslvms4.westeurope.cloudapp.azure.com:/home/perlinig-ethz/*.txt /home/gianni/Scrivania/ASL5.1mw1
		scp perlinig-ethz@perlinig-ethzforaslvms5.westeurope.cloudapp.azure.com:/home/perlinig-ethz/*.txt /home/gianni/Scrivania/ASL5.1mw2
