...
set xrange [0:72] 
set yrange [0:10]
plot "TSBS_wt8_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "MW with 8 Workers" ls 1, "TSBS_wt16_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "MW with 16 Workers" ls 2, "TSBS_wt32_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "MW with 32 Workers" ls 3, "TSBS_wt64_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "MW with 64 Workers" ls 4
