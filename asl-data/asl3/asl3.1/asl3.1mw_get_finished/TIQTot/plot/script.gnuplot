...
set xrange [0:72] 
set yrange [0:20]
plot "TIQ_get_wt8_data.txt" index 00:00 using 1:($2/1000000):($3/1000000):xticlabel(1) with errorlines title "MW with 8 Workers" ls 1, "TIQ_get_wt16_data.txt" index 00:00 using 1:($2/1000000):($3/1000000):xticlabel(1) with errorlines title "MW with 16 Workers" ls 2, "TIQ_get_wt32_data.txt" index 00:00 using 1:($2/1000000):($3/1000000):xticlabel(1) with errorlines title "MW with 32 Workers" ls 3, "TIQ_get_wt64_data.txt" index 00:00 using 1:($2/1000000):($3/1000000):xticlabel(1) with errorlines title "MW with 64 Workers" ls 4
