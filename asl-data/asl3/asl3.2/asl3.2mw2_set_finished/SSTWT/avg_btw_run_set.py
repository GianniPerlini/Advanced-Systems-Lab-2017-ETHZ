...
for w in workers:				
	for c in clients:
		...
		f1 = open("SSTWT_mw2_r1_wt"+str(w)+"_c"+str(c)+".txt", "r")
		f2 = open("SSTWT_mw2_r2_wt"+str(w)+"_c"+str(c)+".txt", "r")
		f3 = open("SSTWT_mw2_r3_wt"+str(w)+"_c"+str(c)+".txt", "r")
		fi = open("SSTWT_mw2_avg_wt"+str(w)+"_c"+str(c)+".txt", "w")
