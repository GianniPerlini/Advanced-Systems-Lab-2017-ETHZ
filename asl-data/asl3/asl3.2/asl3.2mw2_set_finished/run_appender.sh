...
for c in "${clients[@]}"; do
	for wt in "${workers[@]}"; do
		for r in "${reps[@]}"; do
			printf>>QL_set_${op}_c${c}_wt${wt}_tot.txt "r=${r}, wt=${wt}, c=${c}\n"
			printf>>AR_set_${op}_c${c}_wt${wt}_tot.txt "r=${r}, wt=${wt}, c=${c}\n"
			printf>>STH_${op}_c${c}_wt${wt}_tot.txt "r=${r}, wt=${wt}, c=${c}\n"
			printf>>TIQ_set_${op}_c${c}_wt${wt}_tot.txt "r=${r}, wt=${wt}, c=${c}\n"
			...
			cat QL_set_${op}_r${r}_wt${wt}_c${c}.txt >> QL_set_${op}_c${c}_wt${wt}_tot.txt
			cat AR_set_${op}_r${r}_wt${wt}_c${c}.txt >> AR_set_${op}_c${c}_wt${wt}_tot.txt
			cat STH_${op}_r${r}_wt${wt}_c${c}.txt >> STH_${op}_c${c}_wt${wt}_tot.txt
			cat TIQ_set_${op}_r${r}_wt${wt}_c${c}.txt >> TIQ_set_${op}_c${c}_wt${wt}_tot.txt
			...
			printf>>QL_set_${op}_c${c}_wt${wt}_tot.txt "\n"
			printf>>AR_set_${op}_c${c}_wt${wt}_tot.txt "\n"
			printf>>STH_${op}_c${c}_wt${wt}_tot.txt "\n"
			printf>>TIQ_set_${op}_c${c}_wt${wt}_tot.txt "\n"
