...
set xrange [0:72] 
set yrange [0:4]
plot "TParseS_wt8_avg_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 8 Workers each" ls 1, "TParseS_wt16_avg_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 16 Workers each" ls 2, "TParseS_wt32_avg_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 32 Workers each" ls 3, "TParseS_wt64_avg_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 64 Workers each" ls 4
