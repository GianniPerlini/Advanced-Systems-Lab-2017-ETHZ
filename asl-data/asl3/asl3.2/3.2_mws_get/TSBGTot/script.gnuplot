...
set xrange [0:72] 
set yrange [0:7]
plot "TSBG_wt8_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 8 Workers each" ls 1, "TSBG_wt16_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 16 Workers each" ls 2, "TSBG_wt32_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 32 Workers each" ls 3, "TSBG_wt64_data.txt" index 00:00 using 1:($2/100000):($3/100000):xticlabel(1) with errorlines title "2 MWs with 64 Workers each" ls 4
