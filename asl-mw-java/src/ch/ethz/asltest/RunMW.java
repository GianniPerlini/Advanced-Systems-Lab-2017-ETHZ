...
public class RunMW {
	...
	public static void main(String[] args) throws Exception {
		...
		/* 
		 * Only used in Section 5, with 6 keys to let the workers know to print all the response time
		new MyMiddleware(myIp, myPort, mcAddresses, numThreadsPTP, readSharded, keySix).run();
		*/
	...
	private static void parseArguments(String[] args) {
		...
		if(params.get("k") != null) {
			keySix = Boolean.parseBoolean(params.get("k").get(0));
		} */
